...
import MemberCards26 from "./components/MemberCards26";
import MemberCards25 from "./components/MemberCards25";
          ...
          <Grid item md={6} className={classes.center}>
            <Paper className={classes.paper}>
              ...
              <Grid container spacing={2} className={classes.MemCards}>
                {!selectValue || selectValue === "26" ? <MemberCards26 /> : ""}
                {selectValue === "25" ? <MemberCards25 /> : ""}
