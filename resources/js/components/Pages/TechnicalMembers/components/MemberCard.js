...
export default function MemberCard({
  ...
  return (
    <Card className={classes.root}>
      ...
      <h3 className={classes.subheading}>{designation}</h3>
        ...
        <ul className="list-inline" id="list-link">
          {facebook ? (
            <li className="list-inline-item">
              <a className="social-icon" target="_blank" href={facebook}>
                <Facebook />
              </a>
            </li>
          ) : (
          ...
          {twitter ? (
            <li className="list-inline-item mx-1">
              <a className="social-icon" target="_blank" href={twitter}>
                <Twitter />
              </a>
            </li>
          ) : (
          ...
          {linkedIn ? (
            <li className="list-inline-item mx-1">
              <a className="social-icon" target="_blank" href={linkedIn}>
                <Linkedin />
              </a>
            </li>
          ) : (
          ...
          {website ? (
            <li className="list-inline-item mx-1">
              <a className="social-icon" target="_blank" href={website}>
                <Website />
              </a>
            </li>
          ) : (
          ...
          {instagram ? (
            <li className="list-inline-item mx-1">
              <a className="social-icon" target="_blank" href={instagram}>
                <Insta />
              </a>
            </li>
          ) : (
          ...
          {mail ? (
            <li className="list-inline-item mx-1">
              <a className="social-icon" target="_blank" href={mail}>
                <Mail />
              </a>
            </li>
          ) : (
          ...
          {github ? (
            <li className="list-inline-item mx-1">
              <a className="social-icon" target="_blank" href={github}>
                <GitHub />
              </a>
            </li>
          ) : (
