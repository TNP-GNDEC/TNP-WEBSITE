...
class EditDownloads extends React.Component {
    state = {
        title: '',
        link: '',
    }
    ...
    updateData = async (e) => {
        ...
        const res = await axios.patch(`/addDownloadsItems/${id}`, this.state);
    ...
    async componentDidMount(){
        const id = this.props.match.params.id;
        const res = await axios.get(`/addDownloadsItems/${id}/edit`);
