...
class PlacementController extends Controller
{
    public function Data2021()
    {
        ...
        return response()
            ->json(['status' => 200, 'record21' => $record]);
    }
    ...
    public function Data2020()
    {
        ...
        return response()
            ->json(['status' => 200, 'record20' => $record]);
    }
    ...
    public function Data2019()
    {
        ...
        return response()
            ->json(['status' => 200, 'record19' => $record]);
    }
    ...
    public function Data2018()
    {
        ...
        return response()
            ->json(['status' => 200, 'record18' => $record]);
    }
    ...
    public function Data2017()
    {
        ...
        return response()
            ->json(['status' => 200, 'record17' => $record]);
    }
    ...
    public function Data2016()
    {
        ...
        return response()
            ->json(['status' => 200, 'record16' => $record]);
    }
    ...
    public function Data2015()
    {
        ...
        return response()
            ->json(['status' => 200, 'record15' => $record]);
    }
}